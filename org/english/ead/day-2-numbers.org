...
* From one hundred to one thousand
  ...
  point also called a period just like you would see when typing on computer or using an electronic calculator.
...
* From one thousand to one billion
  ...
  English speakers use a decimal point also called a period  just like you would see when typing on computer or using an electronic calculator as in 3.14, an approximation of \pi number.
