...
* Months in a year
  Each time I'm referring to the Nothern Hemisphere I'm talking about France and each time I'm referring to the Southern Hemisphere I'm talking about New Zealand.
** Spring
...
* Countries without the four-season system
  ...
  as in the Caribbean (see [[https://en.wikipedia.org/wiki/Caribbean][Wikipedia]] for more details) or in
