...
\hypersetup{
 ...
 pdftitle={Introduction à la phonétique anglaise},
 pdfkeywords={},
 pdfsubject={},
...
\newglossaryentry{linguistic}
{
  ...
  description={La linguistique est une science qui couvre de nombreux
    domaines relatifs à l'étude du langage parlé ou écrit}
}
...
\part{À propos de ce livre}
   ...
   \input{part1/part1-chap0-how-to-read-this-book}

   \input{part1/part1-chap1-intro}
...
\part{Vowel sounds}\label{part:vow}
    ...
    \input{part3/part3-chap3-front-vowels}
    ...
    \input{part3/part3-chap4-centre-vowels}
    ...
    \input{part3/part3-chap5-back-vowels}
    ...
    \input{part3/part3-chap6-diphtong}
...
\part{Consonant sounds}\label{part:conson}
    ...
    \input{part4/part4-chap7-plosive}
    ...
    \input{part4/part4-chap8-fricative}
    ...
    \input{part4/part4-chap9-affricate}
    ...
    \input{part4/part4-chap10-nasal}
    ...
    \input{part4/part4-chap11-approximant}
...
\part{Conclusion}\label{part:conc}
    ...
    \input{part5/part5-chap12-what-u-ve-done}
    ...
    \input{part5/part5-chap13-advices-add}
    ...
    \input{part5/part5-chap14-other-proj}
    ...
    \input{part5/part5-chap15-appendix-words}
