...
\newcommand{\uks}[1]{% uk sound
  \href{#1}{\includegraphics[width=0.5cm, height=0.3cm]{union-jack-mini}}%
}

\newcommand{\uss}[1]{% us sound
  \href{#1}{\includegraphics[width=0.5cm, height=0.3cm]{us-flag-mini}}%
}

\newcommand{\aus}[1]{% australian sound
  \href{#1}{\includegraphics[width=0.5cm, height=0.3cm]{aussie-flag-mini}}%
}
...
%%%%%%%%%%%%%%%
\newcommand{\speechvow}[1]{%
  Il y en a #1 et pour chaque son, je vous proposerai au moins 4~%
...
\begin{document}
\title{Introduction à la phonétique anglaise comparée à la française; rédigée avec \XeLaTeX}
\hypersetup{
...
\input{chap5-vowels-en}

%\input{chap6-consonants-en}



\end{document}

% excellent article d'Aurélie sur le blog de Superprof https://bit.ly/2DM8jrb
