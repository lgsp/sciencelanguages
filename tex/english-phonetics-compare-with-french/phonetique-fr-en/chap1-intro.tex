...
D'ailleurs comme le montre la première vidéo dans \href{http://doyouspeakenglish.fr/prescriptiviste-ou-descriptiviste/}{cet article}, les zones du cerveau actives
...
décrivent 44, pour le français\footnote{Selon le \GE il y a 36 \textcolor{red}{sons}
  <<~\exFR{purement}~>> français auquel on ajoute le \textcolor{red}{son} \son[~]{ŋ}
...
% ensemble de symbole qui décrit les \textcolor{red}{sons} avec précisément des \textcolor{red}{sons} que
...
\item En français il y a 36 \textcolor{red}{sons}\footnote{Selon le \GE 36 mais selon Sousa il
...
l'\href{https://fr.wikipedia.org/wiki/Alphabet\_phon\%25C3\%25A9tique\_international}{API}\CW{https://fr.wikipedia.org/wiki/Alphabet_phon\%C3\%A9tique_international}
