...
\item \exFR{arrêt} (~\exPH{aʀɛ}~)
  ...
  \item \exFR{Ce matin j'ai attendu à l'arrêt de
    ...
    \href{http://www.wordreference.com/fren/stop}{\exPH{stɔp}}\footnote{Les
      \textcolor{red}{sons} \son[~]{ɒ} et \son[~]{ɔ} sont bien distincts}.
...
\item \exFR{pur} (~\exPH{pyʀ}~)
  \begin{itemize}
  \item \exFR{Paradoxalement, un \textcolor{red}{son} pur\footnote{Je ne peux que vous
...
\item \exFR{saturer} (~\exPH{satyʀe}~)
  ...
  \item \exFR{C'est Jimi Hendrix qui a lancé la mode qui consiste à
      saturer le \textcolor{red}{son} de sa guitare électrique.}
...
\item \exFR{saison} (~\exPH{sɛzɔ̃ }~)
  \begin{itemize}
  \item \exFR{Dans les zones tempérées l'année se découpe en sai\textcolor{red}{sons}.}
  \item \exEN{In temperate zones the year is divided into sea\textcolor{red}{sons}.}
  \end{itemize}
\end{enumerate}         
