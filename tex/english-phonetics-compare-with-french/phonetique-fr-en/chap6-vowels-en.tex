...
\diph{e}{ɪ}{eɪ}{diphthong-1-7}{\son~\phon{e} n'existe pas à l'état isolé en
  anglais et pour le \son~\phon{ɪ} voir page~\pageref{chap:soni}.}
...
\diph{ɔː}{ɪ}{ɔɪ}{diphthong-2-7}{\son~\phon{ɔː} a été étudié page~\pageref{chap:oouvert} et pour le \son~\phon{ɪ} voir page~\pageref{chap:soni}.}
...
\diph{aː}{ɪ}{aɪ}{diphthong-3-7}{\son~\phon{aː} a été étudié
  page~\pageref{chap:sonalong} et pour le \son~\phon{ɪ} voir
...
\LRCF{https://youtu.be/Z-pZswbP0-g}{https://youtu.be/Civ7UBZP99}
...
\item Pour l'anglais britannique on a :
  \diph{ə}{ʊ}{əʊ}{diphthong-4-7}{\son~\phon{ə} a été étudié
...
\item Pour l'anglais américain on a :
  \diph{o}{ʊ}{oʊ}{diphthong-4-7}{\son~\phon{o} n'a pas véritablement été étudié
  parce que ce n'est pas un symbole phonétique dans la langue anglaise
  et pour le \son~\phon{ʊ} voir page~\pageref{sec:omega}.}
...
\LRCF{https://youtu.be/feseqejnkL0}{https://youtu.be/moLTR-dLQQY}

\notation

\begin{itemize}
\item Pour l'anglais britannique on a :
  \diph{ʊ}{ə}{ʊə}{diphthong-8}{\son~\phon{ʊ} a été étudié
  page~\pageref{sec:omega} et pour le \son~\phon{ə} voir
  page~\pageref{sec:sonenv}.}
  \uks{https://youtu.be/feseqejnkL0}
\item Pour l'anglais américain voir le \son~\phon{ʊ} page~\pageref{sec:omega}.
...
\diph{aː}{ʊ}{aʊ}{diphthong-5-7}{\son~\phon{aː} a été étudié
  page~\pageref{chap:sonalong} et pour le \son~\phon{ʊ} voir
...
\begin{itemize}
\item Pour l'anglais britannique on a :
  \diph{ɪ}{ə}{ɪə}{diphthong-6-7}{\son~\phon{ɪ} a été étudié
  page~\pageref{chap:soni} et pour le \son~\phon{ə} voir
...
\item Pour l'anglais américain ce n'est pas une diphtongue c'est tout
  simplement le\son~\phon{ɪ} qui a été étudié page~\pageref{chap:soni}.
...
\item \exEN{\href{http://www.wordreference.com/enfr/near}{near}} qui s'écrit
  phonétiquement
  \href{https://en.oxforddictionaries.com/definition/near}{\phonm{nɪə}}. Exemple
  d'utilisation du mot :
...
\diph{ɛ}{ə}{ɛə}{diphthong-7-7}{\son~\phon{ɛ} a été étudié
  page~\pageref{chap:sone} et pour le \son~\phon{ə} voir
  page~\pageref{chap:sonenv}.}
