...
\subsection{\son{ɛ} parfois noté \son[~]{\href{https://dictionary.cambridge.org/dictionary/english/bed}{e}} à tort}\label{sec:sone}
...
\subsection{\son{ə} qui se note aussi parfois \son[~]{ɜ} à tort }\label{sec:sonenv}
...
\subsection{\son{ɜː} qui se  note aussi parfois \son[~]{əː} à tort}\label{sec:sonenvlong}
...
\subsection{ \son{əʊ} }\label{sec:enenvomegaenv}
...
\subsection{ \son{eə} qui s'écrit aussi parfois \son[~]{ɛə} à tort}\label{sec:eeteenv}
