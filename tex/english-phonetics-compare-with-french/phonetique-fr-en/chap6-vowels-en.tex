\chapter{Vowel sounds}\label{chap:vow}



Un \textcolor{red}{son} de \textcolor{red}{voyelle}\CW{https://en.wikipedia.org/wiki/English_phonology\#Vowels}
...
\subsection{\son{iː}}\label{subsec:ilong}

Ce \textcolor{red}{son} a pour nom technique\dyse{clear-front-unrounded-vowel} :
...
\item \exEN{\href{http://www.wordreference.com/enfr/tea}{tea}} qui s'écrit en phonétique \href{https://en.oxforddictionaries.com/definition/tea}{\exPH{tiː}}
  ...
  \begin{itemize}
  \item\exEN{\href{https://youtu.be/S8SdWEQg6cE}{Every morning} we use to drink \href{https://youtu.be/Euh8dY4EU9o}{tea}.}
...
Ce \textcolor{red}{son} a pour nom technique\dyse{near-close-near-front-unrounded-vowel} :
...
\item \exEN{\href{http://www.wordreference.com/enfr/thin}{thin}} qui s'écrit en phonétique \href{https://en.oxforddictionaries.com/definition/thin}{\exPH{θɪn}}
  ...
  \begin{itemize}
  \item\exEN{Usually female \href{https://youtu.be/IpRSyVcHu-k}{top model} are \href{https://youtu.be/LekA62H17bo}{thin}.}
...
\item \exEN{\href{http://www.wordreference.com/enfr/big}{big}} qui s'écrit phonétiquement \href{https://en.oxforddictionaries.com/definition/big}{\exPH{bɪɡ}}
  ...
  \begin{itemize}
  \item\exEN{\href{https://youtu.be/do7w0j4ybeY}{New York} has got a nickname: the \href{https://youtu.be/Jha4OkG-ixw}{big} apple.}
...
\item \exEN{\href{http://www.wordreference.com/enfr/which}{which}} qui s'écrit phonétiquement \href{https://en.oxforddictionaries.com/definition/which}{\exPH{wɪtʃ}}
  ...
  \begin{itemize}
  \item\exEN{\href{https://youtu.be/DN74ZuSrtxY}{Pick up} a glass on the table. \href{https://youtu.be/5fR\_\_LXDkRg}{Which} one?}
...
\subsection{\son{ɛ}  parfois noté  \son[~]{\href{https://dictionary.cambridge.org/dictionary/english/bed}{e}}
  }\label{sec:sone}
...
Ce \textcolor{red}{son} a pour nom technique\dyse{open-mid-front-unrounded-vowel} :
...
\subsection{\son{æ} noté aussi parfois
  \son[~]{\href{https://en.oxforddictionaries.com/definition/cat}{a}}
  }\label{sec:sonae}

Ce \textcolor{red}{son} a pour nom technique\dyse{near-open-front-unrounded-vowel} :
...
\item \exEN{\href{http://www.wordreference.com/enfr/hand}{hand}} qui s'écrit
  ...
  \begin{itemize}
  \item\exEN{\href{https://youtu.be/-ccNkksrfls}{Maradona} had scored with his \href{https://youtu.be/KDKBY9FqwQg}{hand} during a famous
...
\subsection{\son{ə} qui se note aussi parfois \son[~]{ɜ}  }\label{sec:sonenv}

Ce \textcolor{red}{son} a pour nom technique\dyse{mid-central-vowel} :
...
\begin{itemize}
\item\exEN{Did you know that any \href{https://www.youtube.com/watch?v=W8B2E11TFe0&list=PLwwOk5fvpuuLgntaf5Z9QKh5uV2Vl2Xme}{language} has got its own \href{https://youtu.be/XQJVoS3SlX0}{rhythm}?}
\item\exFR{Saviez-vous que chaque langue a \textcolor{red}{son} propre rythme ?}
\end{itemize}
...
\subsection{\son{ɜː} qui se  note aussi parfois \son[~]{əː} }\label{sec:sonenvlong}

Ce \textcolor{red}{son} a pour nom technique\dyse{open-mid-central-unrounded-vowel} :
...
\item \exEN{\href{http://www.wordreference.com/enfr/turn}{turn}} qui s'écrit
  ...
  \begin{itemize}
  \item\exEN{\href{https://youtu.be/WLTI2rWAlV4}{Turn} off your TV, actually, you should \href{https://youtu.be/pixcJiRq6Tk}{sell it}.}
...
\item \exEN{\href{http://www.wordreference.com/enfr/learn}{learn}} qui
  ...
  \item\exFR{Si tu veux apprendre l'\exEN{anglais}, il faut que tu
      pratiques les \textcolor{red}{sons}.}
  \end{itemize}
...
Ce \textcolor{red}{son} a pour nom technique\dyse{open-mid-back-unrounded-vowel} :
...
\subsection{\son{ɑː} qui devrait plutôt être noté\son[~]{aː}}\label{sec:sonalong}

Ce \textcolor{red}{son} a pour nom technique\dyse{open-back-unrounded-vowel} :
...
\item \exEN{\href{http://www.wordreference.com/enfr/father}{father}} qui
  ...
  \begin{itemize}
  \item\exEN{My \href{https://youtu.be/MZDAUbeSwNY}{father} used to tell me that you never \href{https://youtu.be/gYSZjGeK5VE}{waste your time} when you think.}
  \item\exFR{Mon père avait l'habitude de me dire qu'on ne perd
      jamais \textcolor{red}{son} temps à réfléchir.}
  \end{itemize}
...
\item \exEN{\href{http://www.wordreference.com/enfr/half}{half}} qui s'écrit
  ...
  \begin{itemize}
  \item\exEN{\href{https://youtu.be/XWamnSNgiCM}{Half} time! That's the \href{https://youtu.be/2I2kKXWjwhM}{right moment} to get some drinks!}
...
Ce \textcolor{red}{son} a pour nom technique\dyse{close-back-rounded-vowel} :
...
Ce \textcolor{red}{son} a pour nom technique\dyse{near-close-near-back-rounded-vowel} :
...
Ce \textcolor{red}{son} a pour nom technique\dyse{open-mid-back-rounded-vowel} :
...
Ce \textcolor{red}{son} a pour nom technique\dyse{open-back-rounded-vowel} :
...
\section{Diphthong Vowels}\label{sec:diphtong}

\speech{7}{diphtongues\CW{https://fr.wikipedia.org/wiki/Diphtongue}}



\subsection{\son{eɪ} }\label{sec:ei}

\diph{e}{ɪ}{eɪ}{diphthong-1-7}{\son{e} n'existe pas à l'état isolé en
  anglais et pour le \son[~]{ɪ} voir page~\pageref{sec:soni}.}
...
\subsection{ \son{ɔɪ} }\label{sec:oouverti}

\diph{ɔː}{ɪ}{ɔɪ}{diphthong-2-7}{\son{ɔː} a été étudié page~\pageref{sec:oouvert} et pour le \son[~]{ɪ} voir page~\pageref{sec:soni}.}
...
\subsection{ \son{aɪ} }\label{sec:ai}

\diph{aː}{ɪ}{aɪ}{diphthong-3-7}{\son{aː} a été étudié
  page~\pageref{sec:sonalong} et pour le \son[~]{ɪ} voir
  page~\pageref{sec:soni}.}
...
\subsection{ \son{əʊ} pour les anglais et\son[~]{oʊ} pour les américains}\label{sec:enenvomegaenv}
...
\subsection{ \son{aʊ} }\label{sec:aomega}

\diph{aː}{ʊ}{aʊ}{diphthong-5-7}{\son{aː} a été étudié
  page~\pageref{sec:sonalong} et pour le \son[~]{ʊ} voir
  page~\pageref{sec:omega}.}
...
\subsection{ \son{ɪə} }\label{sec:ieenv}

\begin{itemize}
\item Pour l'anglais britannique on a :
  \diph{ɪ}{ə}{ɪə}{diphthong-6-7}{\son{ɪ} a été étudié
  page~\pageref{sec:soni} et pour le \son[~]{ə} voir
  page~\pageref{sec:sonenv}.}
  \uks{https://www.youtube.com/watch?v=AnjNcqUKSsE}
\item Pour l'anglais américain ce n'est pas une diphtongue c'est tout
  simplement le\son[~]{ɪ} qui a été étudié page~\pageref{sec:soni}.
...
\subsection{ \son{eə} qui devrait plutôt s'écrire le \son[~]{ɛə} à
  juste titre}\label{sec:eeteenv}

\diph{ɛ}{ə}{ɛə}{diphthong-7-7}{\son{ɛ} a été étudié
  page~\pageref{sec:sone} et pour le \son[~]{ə} voir
  page~\pageref{sec:sonenv}.}
